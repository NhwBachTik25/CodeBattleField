...
# Tải về mã nguồn của VNOJ Docker
...
Thay đổi các thông số cài đặt nhằm phù hợp với mục đích sử dụng và tăng tính bảo mật cho webserver. Có 3 nơi mà bạn có thể chỉnh sửa:
...
Note:
- Với mỗi judge, cần thay thế judge01 (judge name), judge01.yml (judge config), 9111 (PID) tương ứng khác nhau.
...
From CodeBattlefield with love!!!

# Reach out to me 👓

https://www.facebook.com/profile.php?id=100076515643406
